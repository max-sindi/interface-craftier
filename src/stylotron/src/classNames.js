...
var classNames = [
    new CssSimpleClassBranch_1["default"]({ className: 'container', fast: 'max-width: 1200px; box-sizing: content-box; width: 100%; margin-left: auto; margin-right: auto; padding-left: 90px; padding-right: 90px' }),
    new CssUnitClassBranch_1["default"]({ className: "w", property: "width", media: true, percent: 200, each5ValuesLimit: 400, eachValueLimit: 50, px: true, vh: 100 }),
    new CssUnitClassBranch_1["default"]({ className: "w-calc", property: "width", classNameCreator: function (mdf) { return "calc(100% + ".concat(mdf, ")"); }, media: true, each5ValuesLimit: 400, eachValueLimit: 50, px: true }),
    new CssUnitClassBranch_1["default"]({ className: "h", property: "height", media: true, percent: 200, each5ValuesLimit: 200, eachValueLimit: 50, px: true, vh: 100 }),
    new CssUnitClassBranch_1["default"]({ className: "max-w", property: "max-width", media: true, percent: 200, each5ValuesLimit: 800, px: true, vh: 100 }),
    new CssUnitClassBranch_1["default"]({ className: "max-h", property: "max-height", media: true, percent: 200, each5ValuesLimit: 200, px: true, vh: 100 }),
    new CssUnitClassBranch_1["default"]({ className: "min-w", property: "min-width", media: true, percent: 200, each5ValuesLimit: 200, px: true, vh: 100 }),
    new CssUnitClassBranch_1["default"]({ className: "min-h", property: "min-height", media: true, percent: 200, each5ValuesLimit: 700, px: true, vh: 100 }),
    new CssUnitClassBranch_1["default"]({ className: "p", property: "padding", media: true, percent: 200, each5ValuesLimit: 200, px: true }),
    new CssUnitClassBranch_1["default"]({ className: "pl", property: "padding-left", media: true, percent: 200, each5ValuesLimit: 400, eachValueLimit: 50, px: true }),
    new CssUnitClassBranch_1["default"]({ className: "pr", property: "padding-right", media: true, percent: 200, each5ValuesLimit: 400, eachValueLimit: 50, px: true }),
    new CssUnitClassBranch_1["default"]({ className: "pt", property: "padding-top", media: true, percent: 200, each5ValuesLimit: 400, eachValueLimit: 50, px: true }),
    new CssUnitClassBranch_1["default"]({ className: "pb", property: "padding-bottom", media: true, percent: 200, each5ValuesLimit: 400, eachValueLimit: 50, px: true }),
    new CssUnitClassBranch_1["default"]({ className: "m", property: "margin", media: true, percent: 200, each5ValuesLimit: 400, px: true }),
    new CssUnitClassBranch_1["default"]({ className: "ml", property: "margin-left", media: true, percent: 200, each5ValuesLimit: 400, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "mr", property: "margin-right", media: true, percent: 200, each5ValuesLimit: 400, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "mt", property: "margin-top", media: true, percent: 200, each5ValuesLimit: 400, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "mb", property: "margin-bottom", media: true, percent: 200, each5ValuesLimit: 400, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "l", property: "left", media: true, percent: 200, each5ValuesLimit: 200, eachValueLimit: 15, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "r", property: "right", media: true, percent: 200, each5ValuesLimit: 200, eachValueLimit: 15, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "t", property: "top", media: true, percent: 200, each5ValuesLimit: 200, eachValueLimit: 15, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "b", property: "bottom", media: true, percent: 200, each5ValuesLimit: 200, eachValueLimit: 15, px: true, minus: true }),
    new CssUnitClassBranch_1["default"]({ className: "fz", property: "font-size", media: true, percent: 200, eachValueLimit: 50, px: true }),
    ...
    new CssUnitClassBranch_1["default"]({ className: "order", property: "order", media: true, eachValueLimit: 10, after: false, before: false }),
    ...
    new CssSimpleClassBranch_1["default"]({ className: "text-wrap", fast: "white-space: wrap", media: true }),
