...
const classNames = [
    new CssSimpleClassBranch({ className: 'container', fast: 'max-width: 1200px; box-sizing: content-box; width: 100%; margin-left: auto; margin-right: auto; padding-left: 90px; padding-right: 90px'}),
    ...
    new CssUnitClassBranch({ className: "w-calc",      property: "width",        classNameCreator: (mdf: string) => `calc(100% + ${mdf})`, media: true, each5ValuesLimit: 400, eachValueLimit: 50, px: true}),
    ...
    new CssUnitClassBranch({ className: "pl",          property: "padding-left",    media: true,  percent:      200,    each5ValuesLimit: 400, eachValueLimit: 50,  px: true}),
    new CssUnitClassBranch({ className: "pr",          property: "padding-right",   media: true,  percent:      200,    each5ValuesLimit: 400, eachValueLimit: 50,  px: true}),
    new CssUnitClassBranch({ className: "pt",          property: "padding-top",     media: true,  percent:      200,    each5ValuesLimit: 400, eachValueLimit: 50,  px: true}),
    new CssUnitClassBranch({ className: "pb",          property: "padding-bottom",  media: true,  percent:      200,    each5ValuesLimit: 400, eachValueLimit: 50,  px: true}),
    new CssUnitClassBranch({ className: "m",           property: "margin",          media: true,  percent:      200,    each5ValuesLimit: 400,  px: true}),
    new CssUnitClassBranch({ className: "ml",          property: "margin-left",     media: true,  percent:      200,    each5ValuesLimit: 400,  px: true, minus: true}),
    new CssUnitClassBranch({ className: "mr",          property: "margin-right",    media: true,  percent:      200,    each5ValuesLimit: 400,  px: true, minus: true}),
    new CssUnitClassBranch({ className: "mt",          property: "margin-top",      media: true,  percent:      200,    each5ValuesLimit: 400,  px: true, minus: true}),
    new CssUnitClassBranch({ className: "mb",          property: "margin-bottom",   media: true,  percent:      200,    each5ValuesLimit: 400,  px: true, minus: true}),
